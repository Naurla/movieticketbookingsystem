...
public class BookingsDatabase {
	...
	public static ArrayList<Booking> getUserBookings(Database database, int userID) {
	...
	public static Booking getBooking(int userID, int bookingID, Database database) {
		Booking booking = new Booking();
	...
	public static int getNextBookingID(Database database, int userID) {
		int ID = 0;
	...
	public static void cancelBooking(Database database, int userID, Scanner s) {
        ...
        public static void cancelBooking(int userID, int bookingID, Database database) {
    try {
        Booking booking = getBooking(userID, bookingID, database);
